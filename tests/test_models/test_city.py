...
class TestCityDocs(unittest.TestCase):
    """City class documentation and style test"""
    @classmethod
    def setUpClass(cls):
        """doc tests set up"""
    ...
    def test_pep8_conformance_city(self):
        """models/city.py standardization to PEP8."""
    ...
    def test_pep8_conformance_test_city(self):
        """tests/test_models/test_city.py standardization to PEP8."""
        pep8s = pycodestyle.StyleGuide(quiet=True)
    ...
    def test_city_func_docstrings(self):
        """docstrings in City methods availability check"""
...
class TestCity(unittest.TestCase):
    ...
    def test_name_attr(self):
        """City has attribute name, and it's a non empty string"""
        city = City()
        self.assertTrue(hasattr(city, "name"))
        self.assertEqual(city.name, "")

    def test_state_id_attr(self):
        """City has attribute state_id, and it's a non empty string"""
        city = City()
    ...
    def test_to_dict_values(self):
        """dict values returned from to_dict are correct"""
    ...
    def test_str(self):
        """Check if str method has the right output"""
        city = City()
